...
def clone(session, target: str, outputDir: str) -> list:
	...
	todo = [
		"/wgl",
		"/static/img/sponsors/ottersec_wgl.png",
		"/static/img/sponsors/htb_wgl.png",
		"/static/bg/Quantico-Bold.ttf",
		"/favicon.ico",
		"/static/bg/Warheed-X3Grd.ttf",
		"/static/bg/OverpassMono-VariableFont_wght.ttf",
		"/static/bg/flag.png",
		"/static/bg/user.png",
		"/static/bg/go.png",
		"/static/bg/info.png",
